...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 vh-100 mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}"  placeholder="+7 (999) 999-99-99"  autocomplete="phone" autofocus>
